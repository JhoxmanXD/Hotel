						...
						<form method="POST" action="{{ route('paymentmethods.store') }}">
								...
								<div class="row">
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											...
											<input type="text" class="form-control" name="description" autocomplete="off" value="{{ old('description') }}" required>
										</div>
									</div>
								</div>
							...
							<div class="card-footer">
								<div class="row">
									...
									<div class="col-lg-2 col-xs-4">
										<a href="{{ route('paymentmethods.index') }}" class="btn border  btn-block btn-flat">Cancelar</a>
									</div>
								</div>
							</div>
						</form>
